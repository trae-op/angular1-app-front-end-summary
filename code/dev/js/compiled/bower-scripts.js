...
.controller('UibAccordionController', ['$scope', '$attrs', 'uibAccordionConfig', function($scope, $attrs, accordionConfig) {
  ...
  // This is called from the accordion-group directives to add itself to the accordion
  ...
  // This is called from the accordion-group directives when to remove itself
...
// The accordion directives simply sets up the directives controllers
...
// The accordion-group directives indicates a block of html that will expand and collapse in an accordion
.directive('uibAccordionGroup', function() {
  return {
    require: '^uibAccordion',         // We need this directives to be inside an accordion
    transclude: true,              // It transcludes the contents of the directives into the template
    restrict: 'A',
    templateUrl: function(element, attrs) {
...
.controller('UibDatepickerController', ['$scope', '$element', '$attrs', '$parse', '$interpolate', '$locale', '$log', 'dateFilter', 'uibDatepickerConfig', '$datepickerLiteralWarning', '$datepickerSuppressError', 'uibDateParser',
  ...
  this.render = function() {
    if (ngModelCtrl.$viewValue) {
      ...
      if (isValid) {
        ...
        $log.error('Datepicker directives: "ng-model" value must be a Date object');
      }
    }
    this.refreshView();
  };
  ...
  // Listen for focus requests from popup directives
...
/**
 * A helper directives for the $modal services. It creates a backdrop element.
 */
  ...
  function($modalStack, $q, $animateCss, $document) {
    return {
      ...
      link: function(scope, element, attrs) {
        ...
        // This property is only added to the scope for the purpose of detecting when this directives is rendered.
        // We can detect that by using this property in the template associated with this directives and then use
        ...
        modalRenderDeferObj.promise.then(function() {
          ...
          $q.when(animationPromise).then(function() {
             ...
             * directives that causes focus) then there's no need to try to focus anything.
             */
...
/**
 * Helper internal services for generating common controllers code between the
...
.provider('$uibTooltip', function() {
  ...
  this.$get = ['$window', '$compile', '$timeout', '$document', '$uibPosition', '$interpolate', '$rootScope', '$parse', '$$stackedMap', function($window, $compile, $timeout, $document, $position, $interpolate, $rootScope, $parse, $$stackedMap) {
    ...
    return function $tooltip(ttType, prefix, defaultTriggerShow, options) {
       ...
       * default to the trigger supplied to this directives factory.
       *
        ...
        compile: function(tElem, tAttrs) {
          ...
          return function link(scope, element, attrs, tooltipCtrl) {
            ...
            function createTooltip() {
              // There can only be one tooltip element per directives shown at once.
              if (tooltip) {
                return;
              }
...
.controller('UibTimepickerController', ['$scope', '$element', '$attrs', '$parse', '$log', '$locale', 'uibTimepickerConfig', function($scope, $element, $attrs, $parse, $log, $locale, timepickerConfig) {
  ...
  this.render = function() {
    ...
    if (isNaN(date)) {
      ngModelCtrl.$setValidity('time', false);
      $log.error('Timepicker directives: "ng-model" value must be a Date object, a number of milliseconds since 01.01.1970 or a string representing an RFC2822 or ISO 8601 date.');
    } else {
      if (date) {
        selected = date;
      }
 ...
 */
  ...
  .controller('UibTypeaheadController', ['$scope', '$element', '$attrs', '$compile', '$parse', '$q', '$timeout', '$document', '$window', '$rootScope', '$$debounce', '$uibPosition', 'uibTypeaheadParser',
    ...
    //create a child scope for the typeahead directives so we are not polluting original scope
  ...
  .filter('uibTypeaheadHighlight', ['$sce', '$injector', '$log', function($sce, $injector, $log) {
    ...
    return function(matchItem, query) {
      ...
      if (!isSanitizePresent) {
        matchItem = $sce.trustAsHtml(matchItem); // If $sanitize is not present we pack the string in a $sce object for the ng-bind-html directives
      }
      return matchItem;
    };
  }]);
  ...
  angular.module('facebook', []).
    ...
    provider('Facebook', [
      function() {
        ...
        /**
         * This defined the Facebook services
         */
        this.$get = [
          '$q',
          '$rootScope',
          ...
          function($q, $rootScope, $timeout, $window) {
             ...
             * Thus, use it as Facebook.subscribe in the services.
             */
             ...
             * Thus, use it as Facebook.unsubscribe in the services.
             */
